...
(doom! :input
       ...
       vi-tilde-fringe   ; fringe tildes to mark beyond
       ...
       (lookup +dictionary)              ; navigate your code and its
       (lsp +peek)               ; M-x vscode
       ...
       (org +brain +pretty +journal +dragndrop
            +gnuplot +noter +pandoc +roam2)        ; organize your plain life in plain text
       ;;php               ; perl's insecure younger brother
       ;;plantuml          ; diagrams for confusing people more
       ;;purescript        ; javascript, but functional
       (python +lsp +tree-sitter +poetry +pyenv +pyright)            ; beautiful is better than ugly
